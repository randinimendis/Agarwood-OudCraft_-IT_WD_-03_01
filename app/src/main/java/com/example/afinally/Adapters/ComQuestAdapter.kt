...
class ComQuestAdapter(var mList: List<Question>) :
    RecyclerView.Adapter<ComQuestAdapter.viewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): viewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.each_item_quest_view, parent, false)
    ...
    override fun onBindViewHolder(holder: viewHolder, position: Int) {
        holder.tvQuestion.text = mList[position].quest
